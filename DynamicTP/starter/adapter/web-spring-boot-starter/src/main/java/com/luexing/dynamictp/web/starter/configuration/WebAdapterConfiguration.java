 ...
 * 掠星 DynamicTP 动态线程池
 */
package com.luexing.dynamictp.web.starter.configuration;

import com.luexing.dynamictp.core.notification.service.NotifierDispatcher;
import com.luexing.dynamictp.web.starter.core.WebThreadPoolRefreshListener;
import com.luexing.dynamictp.web.starter.core.executor.JettyWebThreadPoolService;
import com.luexing.dynamictp.web.starter.core.executor.TomcatWebThreadPoolService;
import com.luexing.dynamictp.web.starter.core.executor.WebThreadPoolService;
